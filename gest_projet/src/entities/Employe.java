 ...
 */
@NamedQueries({
    @NamedQuery(name = "TacheRealiseParEmp", query = "select et.tache from EmployeTache et where et.employe.id = :EmpId"),
    @NamedQuery(name = "ProjetGereParEmp", query = "select p from Projet p where p.chefProjet.id = :iCpId")})
